...
export function Timers(props: ITimersProps) {
    ...
    const columns: ProColumns<TableListItem>[] = [
        ...
        {
            title: '任务名称',
            dataIndex: 'timerName', formItemProps: {
                rules: [{ required: true }]
            }
        },
        {
            ...
            valueType: 'select',
            valueEnum: cronClass,
            hideInSearch: true, formItemProps: {
                rules: [{ required: true }]
            }
        },
        {
    ...
    useEffect(() => {
        const cronList = ["cn.stylefeng.guns.sys.modular.timer.tasks.RefreshConstantsTaskRunner", "cn.stylefeng.guns.sys.modular.timer.tasks.SystemOutTaskRunner"]
        let cronObj: any = {}
    ...
    return (
        ...
        >
            <ProTable<TableListItem>
                ...
                toolBarRender={() => [<Button type="primary" icon={<PlusOutlined />} onClick={() => handleModalVisible(true)}>新增定时任务</Button>]}
            />
            <CreateForm onCancel={() => handleModalVisible(false)}
                ...
                <ProTable<any, any>
                    ...
                    form={{ formRef: createFormRef, layout: 'horizontal', labelCol: { span: 5 }, wrapperCol: { span: 15 }, submitter: { render: false } }}
                    rowKey="key"
                    type="form"
                    columns={columns}
                />
