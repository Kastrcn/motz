...
const NoticeReceived: React.FunctionComponent<INoticeReceivedProps> = (
  props
) => {
  ...
  const columns: ProColumns<any>[] = [
...

    {
      ...
      hideInSearch: true,
      hideInForm: true,
      render: (dom, record) => [<a key="editable">查看</a>],
    },
  ];
  return (
        ...
        dataSource={[
          {
            ...
            createNoticeReceived: "1265476890672672808",
            updateTime: "2020-06-02 21:01:04.000",
            updateNoticeReceived: "1265476890672672808",
